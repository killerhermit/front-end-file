            ...
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <!-- ============================================================== -->
                                    ...
                                    <button type="button" class="btn waves-effect waves-light btn-rounded btn-warning">Login</button>
                                    <button type="button" class="btn waves-effect waves-light btn-rounded btn-danger">Register</button> 
            </nav>
        </header>
        <!-- ============================================================== -->
        <!-- End Topbar header -->
